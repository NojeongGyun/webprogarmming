...
-<mark> 연산자 </mark>-
연산자에는 산술 연산자, 증감 연산자, 대입 연산자, 비교 연산자, 논리 연산자, 조건 연산자, 비트 연산자, 문자열 연산자가 있습니다.
...
<b>대입 연산자 </b>-
대입 연산자는 오른쪽에서 왼쪽으로 변수에 대입 시키는 연산을 하는 연산자를 말합니다. 할당 연산자(=)가 오기전 산술 연산자, 비트 연산자, 논리 연산자가 오면 
